...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    def stat_pill(label, val, color, sub=None):
        sub_html = f"<div style='font-size:8px;color:{color}cc;margin-top:2px;font-family:monospace'>{sub}</div>" if sub else ""
        return (
            f"<div style='text-align:center;background:{color};border-radius:8px;"
            f"padding:8px 6px;flex:1;min-width:60px;max-width:90px'>"
            f"<div style='font-family:monospace;font-size:7px;color:#00000099;"
