...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    @st.cache_data(show_spinner=False)
    def _build_style_df(df_hash: int, df_json: str,
                        baselines_hash: int, vaa_hash: int) -> pd.DataFrame:
        """Returns a DataFrame of CSS strings — serializable, cacheable."""
    ...
    _style_df, _fmt = _build_style_df(_df_hash, _df_json, _base_hash, _vaa_hash)
