...
/* Hide ALL Streamlit widget labels globally — we render our own via .field-label */
...
/* The "{LABEL}" text node — Streamlit renders it in a <p> inside the label */
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    def stat_pill(label, val, color, sub=None):
        ...
        return (
            ...
            f"border-radius:6px;padding:8px 6px;min-width:70px'>"
            ...
            if not active:
                ...
                for group in active:
                    ...
                    card_html = (
                        ...
                        "<div style='border-top:1px solid #0f2030;padding-top:6px;margin-top:4px;"
                        "display:flex;justify-content:space-between;align-items:center'>"
                        "<div style='display:flex;gap:8px'>"
                        f"<span style='font-family:monospace;font-size:9px;"
                        f"background:{vaa_gc}22;border:1px solid {vaa_gc}55;"
                        f"border-radius:3px;padding:2px 6px;"
                        f"color:{vaa_gc}'>VAA {vaa_s}</span>"
                        f"<span style='font-family:monospace;font-size:9px;"
                        f"background:{haa_gc}22;border:1px solid {haa_gc}55;"
                        f"border-radius:3px;padding:2px 6px;"
                        f"color:{haa_gc}'>HAA {haa_s}</span>"
                        "</div>"
                        f"<span style='font-family:monospace;font-size:9px;"
                        f"color:#1e3a50'>{n_str} pitches</span>"
                        "</div></div>"
                    )
