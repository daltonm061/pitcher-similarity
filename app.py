...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    # CSS to make the HM buttons tiny and gap-free
    st.markdown("""<style>
    /* Compact HM button column */
    div.hm-btn-col div[data-testid="stVerticalBlock"] {
        gap: 0px !important;
        padding: 0 !important;
    }
    div.hm-btn-col div[data-testid="stVerticalBlock"] > div {
        margin: 0 !important;
        padding: 0 !important;
    }
    div.hm-btn-col button {
    ...
    with btn_col:
        st.markdown("<div class='hm-btn-col'>", unsafe_allow_html=True)
        st.markdown("<div class='hm-hdr'>HM</div>", unsafe_allow_html=True)
