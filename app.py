            ...
            if _do_score and dm_added:
                ...
                if pitches_dict:
                    ...
                    if scores:
                        ...
                        if _scored_vals:
                            # Simple average — empirically stronger vs external outcomes
                            # (CSW%, xwOBA) than the arsenal-level model. Model kept in
                            # _score_arsenal_model() for future experimentation.
