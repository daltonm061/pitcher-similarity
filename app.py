...
# Prefer v2 (aggregated outcome target), fall back to v1 (per-pitch xRV).
_ZONE_BUNDLE_PATHS = ["models/zone_stuff_v2.joblib", "models/zone_stuff_v1.joblib"]

def load_zone_stuff():
    """Load zone-Stuff+ bundle, preferring newer versions. Returns None if missing/invalid."""
    for path in _ZONE_BUNDLE_PATHS:
