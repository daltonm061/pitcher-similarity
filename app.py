...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    # ── Sort controls — selectbox + direction toggle ─────────────────────────
    ...
    _sc1, _sc2, _sc3 = st.columns([1.5, 0.5, 9])
    with _sc1:
        sort_col = st.selectbox(
            "Sort by", filter_cols,
            index=filter_cols.index(st.session_state["lb_sort_col"])
                  if st.session_state["lb_sort_col"] in filter_cols else 0,
            key="_lb_sort_sel",
            label_visibility="collapsed",
        )
    ...
    with _sc2:
        ...
        if st.button("↑" if sort_asc else "↓", key="_lb_sort_dir",
                     help="Toggle sort direction"):
            st.session_state["lb_sort_asc"] = not sort_asc
            st.rerun()
        sort_asc = st.session_state["lb_sort_asc"]
