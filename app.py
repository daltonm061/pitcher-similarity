...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    # ── Apply range filters — read directly from widget session state keys ──────
    for col in filter_cols:
        mn = st.session_state.get(f"lb_min_{col}")
        mx = st.session_state.get(f"lb_max_{col}")
        # value=None means blank (no filter); skip None and NaN
