            ...
            if not active:
                ...
                for group in active:
                    ...
                    def _pc(lbl, val, c, sub=None):
                        """Pill cell for pitcher card 3×3 grid."""
                        sub_h = f"<div style='font-family:monospace;font-size:8px;color:#6a90a8;margin-top:1px'>{sub}</div>" if sub else ""
                        return (
                            f"<div style='text-align:center;background:{c}18;"
                            f"border:1px solid {c}30;border-radius:8px;padding:8px 4px'>"
                            f"<div style='font-family:JetBrains Mono,monospace;font-size:8px;"
                            f"color:#7aaac0;text-transform:uppercase;letter-spacing:1px;"
