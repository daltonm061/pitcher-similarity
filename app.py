                    ...
                    if scores:
                        ...
                        try:
                            ...
                            for _, _row in _aplus_pp.iterrows():
                                ...
                                if not _overlap:
                                    continue
                                # Distance = avg Euclidean dist on overlapping pitches
                                _dist = 0.0
                                for _g in _overlap:
                                ...
                                _missing_penalty = (len(_user_grps) - len(_overlap)) * 15.0
                                _dist = (_dist / len(_overlap)) + _missing_penalty
                                if _dist < _best_dist:
                                    _best_dist = _dist
                                    _best_row  = _row

                            # Build matched pitcher points
                            _match_pts = {}
                            _match_name = ""
                            ...
                            # Draw plot
                            _fig, _ax = _plt.subplots(figsize=(7, 5.5))
