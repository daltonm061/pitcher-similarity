                ...
                with _clr:
                    ...
                    def _make_clr_max(c):
                        def _fn():
                            ...
                            st.session_state["_lb_hm_idx"] = None
                        return _fn
                    st.button("×", key=f"_clr_max_{col}", help=f"Clear MAX {col}",
                              on_click=_make_clr_max(col), width='stretch')
                ...
                with _clr:
                    ...
                    def _make_clr_min(c):
                        def _fn():
                            ...
                            st.session_state["_lb_hm_idx"] = None
                        return _fn
                    st.button("×", key=f"_clr_min_{col}", help=f"Clear MIN {col}",
                              on_click=_make_clr_min(col), width='stretch')
