...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    # Suppress the grey loading overlay on the dataframe during reruns
    st.markdown("""<style>
    div[data-testid="stDataFrame"] iframe { opacity: 1 !important; }
    div[data-testid="stDataFrame"] > div > div[class*="overlay"] { display: none !important; }
    div[data-testid="stDataFrame"] > div[class*="stale"] { opacity: 1 !important; }
