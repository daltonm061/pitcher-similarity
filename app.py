            ...
            with st.expander(
                ...
                for group in PITCH_GROUPS:
                    ...
                    for col_w, (label, mlb_val, user_val, unit, scale, is_movement) in zip(
                        ...
                        # When user has no input for this metric, show MLB value cleanly
                        if user_val is None:
                            col_w.metric(
                                label=f"{label}",
                                value=mlb_str,
                ...
                # FanGraphs Stuff+ — shown once per pitcher, below all pitch cards
