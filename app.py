...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    def render_comp_section(title_label, title_color, groups_to_show):
        ...
        for grp in groups_to_show:
            ...
            # 3×3 pill grid: Row1=Velo/iVB/HB, Row2=VAA/HAA/DM Stuff+, Row3=Whiff%/CSW%/xwOBA
            pills_html = (
    ...
    for idx, r in enumerate(results):
        ...
        with st.expander(header, expanded=(idx == 0)):
            ...
            # ── Overall DM Stuff+ from profiles CSV ──────────────────
            ...
            if not active:
                ...
                for group in active:
                    ...
                    # ── Look up per-pitch DM Stuff+ (falls back to overall) ──────
