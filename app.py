        ...
        for grp in groups_to_show:
            ...
            pills_html = (
                ...
                + stat_pill("TJ S+",  fv("stuff_plus","i"),    sp_c if sp_val else "#3a4a5a",
                            (f"{user_tjsp[grp]:.0f} you"
                             if grp in user_tjsp and (
                                 snap.get("pitch_inputs",{}).get(grp,{}).get("velo")
                                 or (result_mode == "single" and snap.get("sp_velo") and grp == snap.get("sp_pitch_type"))
                             )
                ...
                for group in active:
                    ...
                    card_html = (
                        ...
                        + _pc("TJ S+",  sp_str,   sp_color,
                               (f"{user_tjsp[group]:.0f} you"
                                if group in user_tjsp and (
                                    snap.get("pitch_inputs",{}).get(group,{}).get("velo")
                                    or (result_mode == "single" and snap.get("sp_velo") and group == snap.get("sp_pitch_type"))
                                )
