...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    def stat_pill(label, val, color, sub=None):
        """Unified pill: vibrant solid bg from comp pills + structured layout from pitcher cards."""
        sub_html = (
        ...
        return (
            ...
            f"border-radius:8px;padding:8px 6px;filter:brightness(1.25)'>"
            f"<div style='font-family:JetBrains Mono,monospace;font-size:7px;"
            f"color:#00000088;text-transform:uppercase;letter-spacing:1.5px;"
            ...
            if not active:
                ...
                for group in active:
                    ...
                    def _pc(lbl, val, c, sub=None):
                        """Same unified pill style as stat_pill — vibrant bg, structured layout."""
                        sub_h = (
                            f"<div style='font-family:monospace;font-size:8px;"
                            f"color:#00000099;margin-top:2px;letter-spacing:0.5px'>{sub}</div>"
                        ) if sub else ""
                        return (
                            ...
                            f"<div style='font-family:JetBrains Mono,monospace;font-size:7px;"
                            f"color:#00000088;text-transform:uppercase;letter-spacing:1.5px;"
                            f"margin-bottom:4px;font-weight:600'>{lbl}</div>"
                            f"<div style='font-family:Inter,sans-serif;font-size:20px;"
                            f"font-weight:700;color:#000000;line-height:1'>{val}</div>"
                            f"{sub_h}</div>"
                        )
