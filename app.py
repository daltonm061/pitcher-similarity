...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    # Left: narrow column of 📊 buttons (one per row + header spacer)
    ...
    with btn_col:
        st.markdown(
            ...
            "font-family:monospace;font-size:8px;color:#7aaac0;text-transform:uppercase;"
            "letter-spacing:1px'>MAP</div>",
            unsafe_allow_html=True,
        )
        for idx_r, label in enumerate(row_labels):
            ...
            if st.button(
                ...
                if is_selected:
                    # Click active row = deselect
                    st.session_state["lb_hm_row"] = "— select a pitch —"
                else:
                    st.session_state["lb_hm_row"] = label
                st.rerun()
